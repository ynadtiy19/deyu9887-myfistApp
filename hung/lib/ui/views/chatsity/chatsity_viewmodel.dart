...
class ChatsityViewModel extends BaseViewModel {
  ...
  static File? _imageBackground = null;
  ...
  Future<Map<String, dynamic>?> sendmessage(
    ...
    final String apiUrl = 'https://mydiumtify.globeapp.dev/chattext?q=$query';
  ...
  Future<void> chatwithImage(String text, BuildContext context) async {
    ...
    //http://localhost:8080/chatadvance
